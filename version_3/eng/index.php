...
<h1 style="font-size: 3em">Communiquez avec vos commerçants par message</h1>
...
if ($row) {
  header("Location: landing?Timer_end=$shuffle");
}

header("Refresh: 45; url=landing?Timer_end=$shuffle");

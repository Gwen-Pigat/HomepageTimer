...
if (isset($_GET['token_invite'])) {
      ...
      mysqli_query($link, "INSERT INTO Catcher(email, identifiant, version, adresse_ip, date) VALUES ('$_POST[email]','$random',2,'$ip','$date')");
...
//Check la méthode post + si le champ n'était pas vide
  ...
  if (isset($_POST) && isset($_POST['email'])) {
      ...
      // Define who the message is from
      $mail->FromName = 'VERSION 2 // Textr - Catch ';
